...
public class LarionMod {
	...
	public static final RegistryObject<Codec<? extends DensityFunction>> DIV = DENSITY_FUNCTION_TYPES.register("div",
			() -> {
				return Division.CODEC.codec();
			});

	public static final RegistryObject<Codec<? extends DensityFunction>> SQRT = DENSITY_FUNCTION_TYPES
			.register("sqrt", () -> {
				return Sqrt.CODEC.codec();
			});

	public static final RegistryObject<Codec<? extends DensityFunction>> SIGNUM = DENSITY_FUNCTION_TYPES
			.register("signum", () -> {
				return Signum.CODEC.codec();
			});

	public static final RegistryObject<Codec<? extends DensityFunction>> SINE = DENSITY_FUNCTION_TYPES
			.register("sine", () -> {
				return Sine.CODEC.codec();
			});

	public static final RegistryObject<Codec<? extends DensityFunction>> X_COORD = DENSITY_FUNCTION_TYPES
			.register("x", () -> {
				return XCoord.CODEC.codec();
			});

	public static final RegistryObject<Codec<? extends DensityFunction>> Z_COORD = DENSITY_FUNCTION_TYPES
			.register("z", () -> {
				return ZCoord.CODEC.codec();
			});

	public static final RegistryObject<Codec<? extends DensityFunction>> FLAT_DOMAIN_WARP = DENSITY_FUNCTION_TYPES
	...
	public static final RegistryObject<Codec<? extends ConditionSource>> SOMEWHAT_STEEP = MATERIAL_CONDITIONS
